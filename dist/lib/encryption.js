 ...
 */
export function deriveSecretFromToken(accessToken) {
 ...
 */
export function deriveSecretFromEmail(email) {
    const appSecret = process.env.NEXTAUTH_SECRET || "fallback-secret";
    return crypto
        .createHash("sha256")
 ...
 */
export function encryptApiKey(apiKey, userEmail) {
 ...
 */
export function decryptApiKey(encryptedKey, userEmail) {
    const secret = deriveSecretFromEmail(userEmail);
