 ...
 */
function saveCredentials(refreshToken: string, email: string): void {
  ensureDataDir()
 ...
 */
function loadCredentials(): { refreshToken: string; email: string } | null {
...
function createOAuth2Client() {
  ...
  return new google.auth.OAuth2(
    clientId,
    clientSecret,
    "http://localhost:3847/callback" // Local callback for OAuth
  )
}
 ...
 */
async function performOAuthFlow(): Promise<{ refreshToken: string; email: string }> {
